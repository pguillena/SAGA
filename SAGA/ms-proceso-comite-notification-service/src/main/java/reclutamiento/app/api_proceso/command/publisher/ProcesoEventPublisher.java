...
public class ProcesoEventPublisher {
    ...
    public void publishProcesoComiteNotificated(UUID sagaId, UUID procesoId) {
    ...
    public void publishProcesoComiteNotificationFailed(UUID sagaId, String reason) {
        ...
        rabbitTemplate.convertAndSend(
                EXCHANGE,
                "proceso.comite.notification.failed",
                event
        );
    }
}