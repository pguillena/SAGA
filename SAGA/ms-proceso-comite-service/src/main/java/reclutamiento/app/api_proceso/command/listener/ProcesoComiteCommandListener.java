...
public class ProcesoComiteCommandListener {
    ...
    @RabbitListener(queues = "proceso.comite.create.queue")
    public void handleCreateProcesoComite(CreateProcesoComiteCommand command) {
        procesoComiteCommandService.createProcesoComite(command);
    }
}